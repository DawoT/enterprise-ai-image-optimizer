...
type SettingsTab = 'general' | 'security' | 'limits';
...
export default function SystemSettingsPanel() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'general':
        return <GeneralSettings onSettingsChange={handleSettingsChange} />;
      case 'security':
        return <SecuritySettings onSettingsChange={handleSettingsChange} />;
      case 'limits':
        return <LimitsSettings onSettingsChange={handleSettingsChange} />;
      default:
        return null;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage application settings, security policies, and system limits
            </p>
          </div>
          {hasUnsavedChanges && (
      ...
      <div className="fixed bottom-0 left-0 right-0 border-t border-gray-200 bg-white px-6 py-3">
        <div className="mx-auto flex max-w-4xl items-center justify-between text-sm text-gray-500">
